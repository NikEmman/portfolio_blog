const projectData = [
  ...
  },
  {
    ...
    imgUrl: "roxanne.png",
    largeDescription:
      "A 2-D puzzle game, where the player has to program a robot vacuum to visit dirty spots and then watch the execution play out. Every 5 levels a password screen appears that will allow on a new playthrough to start at a later level, thus urging the child to write down a few letters. Available for Windows/Mac/Linux",
    github: "https://github.com/NikEmman/homecoming",
    created: "Oct 2025",
    live: "https://nikemman.itch.io/roxannes-quest",
  },
  {
    title: "Battleship",
    ...
    created: "Oct 2024",
    live: "https://nikemman.github.io/battleship",
  },
];
